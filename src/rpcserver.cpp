...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Pure features */
        {"pure", "masternode", &masternode, true, true, false},
        {"pure", "listmasternodes", &listmasternodes, true, true, false},
        {"pure", "getmasternodecount", &getmasternodecount, true, true, false},
        {"pure", "masternodeconnect", &masternodeconnect, true, true, false},
        {"pure", "masternodecurrent", &masternodecurrent, true, true, false},
        {"pure", "masternodedebug", &masternodedebug, true, true, false},
        {"pure", "startmasternode", &startmasternode, true, true, false},
        {"pure", "createmasternodekey", &createmasternodekey, true, true, false},
        {"pure", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"pure", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"pure", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"pure", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"pure", "getmasternodescores", &getmasternodescores, true, true, false},
        {"pure", "mnbudget", &mnbudget, true, true, false},
        {"pure", "preparebudget", &preparebudget, true, true, false},
        {"pure", "submitbudget", &submitbudget, true, true, false},
        {"pure", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"pure", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"pure", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"pure", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"pure", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"pure", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"pure", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"pure", "checkbudgets", &checkbudgets, true, true, false},
        {"pure", "mnsync", &mnsync, true, true, false},
        {"pure", "spork", &spork, true, true, false},
        {"pure", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"pure", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use pured, or the -server option to pure-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> pure-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:47121/\n";
}
