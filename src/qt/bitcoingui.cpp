...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Pure address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and pure: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Pure"), this);
    aboutAction->setStatusTip(tr("Show information about Pure"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Pure"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Pure addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Pure addresses"));
    ...
    openAction->setStatusTip(tr("Open a Pure: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Pure help message to get a list with possible Pure command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Pure client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Pure network", "", count));
}
...
{
    QString strTitle = tr("Pure"); // default title
