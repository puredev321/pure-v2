...
RESOURCES += src/qt/pure.qrc src/qt/pure_locale.qrc

TRANSLATIONS += src/qt/locale/pure_bg.ts \
                src/qt/locale/pure_de.ts \
                src/qt/locale/pure_en.ts \
                src/qt/locale/pure_es.ts \
                src/qt/locale/pure_fi.ts \
                src/qt/locale/pure_fr.ts \
                src/qt/locale/pure_it.ts \
                src/qt/locale/pure_ja.ts \
                src/qt/locale/pure_pl.ts \
                src/qt/locale/pure_pt.ts \
                src/qt/locale/pure_ru.ts \
                src/qt/locale/pure_sk.ts \
                src/qt/locale/pure_sv.ts \
                src/qt/locale/pure_vi.ts \
                src/qt/locale/pure_zh_CN.ts \
                src/qt/locale/pure_zh_TW.ts
