...
This mechanism has been integrated into Bitcore-Node-Pure which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/Pure-Project/insight-api-pure#web-socket-api](https://github.com/Pure-Project/insight-api-pure#web-socket-api) 
* API: [https://github.com/Pure-Project/insight-api-pure#swifttx-transactions](https://github.com/Pure-Project/insight-api-pure#swifttx-transactions) 
...
By default, the Pure daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Pure daemon:
