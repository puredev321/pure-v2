...
In order to support loading of multiple wallets in pure-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is pure.cpp.
...
Changes to pure.cpp
----------------------
pure.cpp is the entry point into pure-qt, and as such, will require some minor modifications to provide hooks for
