...
The Pure project operates an open contributor model where anyone is
...
The following applies to code changes to the Pure project, and is not to be
confused with overall Pure Network Protocol consensus changes.

Whether a pull request is merged into Pure rests with the project merge
...
Patches that change Pure consensus rules are considerably more involved than
...
Where a patch set proposes to change the Pure consensus, it must have been
...
The project leader is the release manager for each Pure release.
